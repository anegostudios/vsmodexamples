...
namespace VSTutorial
{
    ...
    public class VSTutorialModSystem : ModSystem
    {
        ...
        {
            /*
             * This registers a new item class to be used in the game.
             ...
             * After registering, any items with the property: ' ("class":"vstutorial.thornsblade") ' will use the ItemThornsBlade class.
             */
